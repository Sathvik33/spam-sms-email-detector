...
MODEL_PATH = r'C:\C_py\Python\Scikit\Spam_classification_model.pkl'
VEC_PATH = r'C:\C_py\Python\Scikit\tfidf_vectorizer.pkl'
DATA_PATH = r"C:\C_py\Python\Scikit\email\data\email_classification.csv"
